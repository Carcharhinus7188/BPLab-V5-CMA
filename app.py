...
# Android 14 原装浏览器兼容样式：低DOM、无动画、无横向溢出、触控按钮加大。
st.markdown(
    """
<style>
...
.block-container{max-width:720px!important;padding:.55rem .55rem 1.25rem!important}
.stApp{background:#f7f9fb!important}
...
h1{font-size:1.28rem!important;line-height:1.35!important;margin:.05rem 0 .2rem!important}
h2,h3{font-size:1.03rem!important;line-height:1.35!important;margin:.35rem 0!important}
p,label,[data-testid="stCaptionContainer"]{line-height:1.45!important}
.stButton button,.stDownloadButton button,.stFormSubmitButton button{min-height:48px!important;width:100%!important;font-size:16px!important;touch-action:manipulation!important;border-radius:6px!important;transition:none!important}
input,textarea,button,[role="combobox"]{font-size:16px!important}
.stTextInput input,.stNumberInput input,.stDateInput input{min-height:46px!important;padding:.45rem .55rem!important}
div[data-baseweb="select"]>div{min-height:46px!important}
textarea{min-height:82px!important}
[data-testid="stForm"]{border:1px solid #dce3e8!important;border-radius:6px!important;padding:.55rem!important;background:#fff!important}
[data-testid="stExpander"]{border-radius:6px!important}
[data-testid="stAlert"]{padding:.55rem!important}
hr{margin:.45rem 0!important}
[data-testid="stVerticalBlock"]{gap:.42rem!important}
[data-testid="stHorizontalBlock"]{flex-wrap:wrap!important}
.stCheckbox{min-height:38px!important}
@media(max-width:600px){
 .block-container{padding:.4rem .42rem 1rem!important}
 h1{font-size:1.18rem!important}
 .stButton button,.stDownloadButton button,.stFormSubmitButton button{min-height:50px!important}
}
</style>
""",
...
if step.startswith("1"):
    ...
    st.caption(f"录入进度：{completed}/{len(record['rows'])} 个")
